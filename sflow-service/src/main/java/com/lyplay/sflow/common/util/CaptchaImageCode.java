...
public class CaptchaImageCode {
	...
	public static int DEFAULT_LINECOUNT = 20;
	...
	public CaptchaImageCode() {
		creatImage();
	}

	public CaptchaImageCode(int width, int height) {
		this.width = width;
		this.height = height;
		creatImage();
	}

	public CaptchaImageCode(int width, int height, int codeCount) {
		this.width = width;
		this.height = height;
	...
	public CaptchaImageCode(int width, int height, int codeCount, int lineCount) {
		this.width = width;
		this.height = height;
		this.codeCount = codeCount;
	...
	private String randomStr(int n) {
		...
		int len = CAPTCHA_STR.length() - 1;
		double r;
		for (int i = 0; i < n; i++) {
			r = (Math.random()) * len;
			str2.append(CAPTCHA_STR.charAt((int) r));
		}
