...
public class DAOWriterUtil {
	...
	public static String getDAOClazzCode(String tableName, String daoClazzName, String poClazzName, String columnList) {
		...
		sb.append("import java.util.Collections;").append(CommonWriterUtil.NEW_LINE);
		sb.append("import java.util.List;").append(CommonWriterUtil.NEW_LINE).append(CommonWriterUtil.NEW_LINE);
		...
		sb.append("import org.springframework.dao.EmptyResultDataAccessException;").append(CommonWriterUtil.NEW_LINE);
		sb.append("import org.springframework.stereotype.Repository;").append(CommonWriterUtil.NEW_LINE).append(CommonWriterUtil.NEW_LINE);

		sb.append("import com.gpayroll.common.base.BaseDAO;").append(CommonWriterUtil.NEW_LINE);
		...
		String daoName = String.format("%sDAO", CommonWriterUtil.unCapitalize(tableName, false));
		String rowMapperName = String.format("%sRowMapper", CommonWriterUtil.unCapitalize(tableName, false));

		sb.append(String.format("@Repository(\"%s\")", daoName)).append(CommonWriterUtil.NEW_LINE);
		sb.append(String.format("public class %s extends BaseDAO {", daoClazzName)).append(CommonWriterUtil.NEW_LINE);
		...
		// method getList
		sb.append(CommonWriterUtil.TABLE_SPACE).append(String.format("public List<%s> getList() {", poClazzName)).append(CommonWriterUtil.NEW_LINE);
		sb.append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append("try {").append(CommonWriterUtil.NEW_LINE);
		sb.append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE)
				.append("String querySql = String.format(\"select %s from %s\", this.getColumn(), TABLE_NAME);").append(CommonWriterUtil.NEW_LINE);
		sb.append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append(String.format("return getJdbcTemplate().query(querySql, %s);", rowMapperName))
				.append(CommonWriterUtil.NEW_LINE);
		sb.append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append("} catch (EmptyResultDataAccessException e) {").append(CommonWriterUtil.NEW_LINE);
		sb.append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append("LOG.error(e.getMessage(), e);").append(CommonWriterUtil.NEW_LINE);
		sb.append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append("return Collections.emptyList();").append(CommonWriterUtil.NEW_LINE);
		sb.append(CommonWriterUtil.TABLE_SPACE).append(CommonWriterUtil.TABLE_SPACE).append("}").append(CommonWriterUtil.NEW_LINE);
		sb.append(CommonWriterUtil.TABLE_SPACE).append("}").append(CommonWriterUtil.NEW_LINE).append(CommonWriterUtil.NEW_LINE);
